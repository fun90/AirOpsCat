...
@RegisterForReflection(targets = {
    ...
    com.fun90.airopscat.model.dto.AccountOnboardingUserRequest.class,
    com.fun90.airopscat.model.dto.AccountOnboardingRequest.class,
    com.fun90.airopscat.model.dto.AccountOnboardingResponse.class,
    ...
    com.fun90.airopscat.model.dto.guard.GuardOnlineAccountIpReport.class,
    com.fun90.airopscat.model.dto.guard.GuardOnlineConnectionRefReport.class,
    ...
    com.fun90.airopscat.model.dto.VnstatPointDto.class,
    com.fun90.airopscat.model.entity.ServerVnstatStats.class,
    com.fun90.airopscat.model.dto.NodeOnlineAccountDailyPointDto.class,
    com.fun90.airopscat.model.dto.NodeOnlineAccountOverviewChartDto.class,
    com.fun90.airopscat.model.dto.NodeOnlineAccountOverviewDailyPointDto.class,
    com.fun90.airopscat.model.dto.NodeOnlineAccountOverviewNodeRankDto.class,
    com.fun90.airopscat.model.dto.NodeOnlineAccountOverviewSummaryDto.class,
    com.fun90.airopscat.model.dto.NodeOnlineAccountStatsChartDto.class,
    com.fun90.airopscat.model.dto.NodeOnlineAccountStatsSummaryDto.class,
    ...
    com.fun90.airopscat.model.entity.NodeOnlineAccountDailyStats.class,
    ...
    com.fun90.airopscat.model.entity.SystemRequestLog.class,
