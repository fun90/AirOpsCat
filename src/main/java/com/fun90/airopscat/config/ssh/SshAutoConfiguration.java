...
import com.fun90.airopscat.service.ssh.provider.ApacheSshdConnectionProvider;
...
public class SshAutoConfiguration {
    ...
    @Bean
    @ConditionalOnProperty(name = "airopscat.ssh.provider", havingValue = "apache-sshd", matchIfMissing = true)
    public SshConnectionProvider apacheSshdProvider() {
        return new ApacheSshdConnectionProvider();
    }
